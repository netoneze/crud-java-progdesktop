...
public class AlunosView extends javax.swing.JFrame {
    ...
    public void LoadTable(){
        ...
        var listaAlunos = AlunoDAO.listaAluno();
        ...
        for (int i = 0; i < listaAlunos.size(); i++) {
            model.addRow(new Object[]{
                ...
                listaAlunos.get(i).getEmail(),
                listaAlunos.get(i).getRegistroAcademico()
            });
        }
    ...
    private void initComponents() {
        ...
        if (tabela_aluno.getColumnModel().getColumnCount() > 0) {
            tabela_aluno.getColumnModel().getColumn(0).setMinWidth(20);
            tabela_aluno.getColumnModel().getColumn(0).setPreferredWidth(30);
            tabela_aluno.getColumnModel().getColumn(0).setMaxWidth(50);
        }
    ...
    private void btn_criarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_criarActionPerformed
        ...
        if( AlunoDAO.SalvarAluno(field_registroacademico.getText(), field_nome.getText(), field_email.getText())){
    ...
    private void btn_atualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_atualizarActionPerformed
        int id = Integer.valueOf(String.valueOf(tabela_aluno.getValueAt(tabela_aluno.getSelectedRow(), 0)));
        String nome = String.valueOf(tabela_aluno.getValueAt(tabela_aluno.getSelectedRow(), 1));
        String email = String.valueOf(tabela_aluno.getValueAt(tabela_aluno.getSelectedRow(), 2));
        String registroAcademico = String.valueOf(tabela_aluno.getValueAt(tabela_aluno.getSelectedRow(), 3));
        if( AlunoDAO.ModificarAluno(id, registroAcademico, nome, email)){
            this.LoadTable();
    ...
    private void tabela_alunoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabela_alunoMouseClicked
        ...
        field_nome.setText(String.valueOf(tabela_aluno.getValueAt(index, 1)));
        field_email.setText(String.valueOf(tabela_aluno.getValueAt(index, 2)));
        field_registroacademico.setText(String.valueOf(tabela_aluno.getValueAt(index, 3)));
