...
import Controllers.TerceiroDAO;
 ...
 */
public class TerceirosView extends javax.swing.JFrame {

    public void LoadTable(){
        DefaultTableModel model = (DefaultTableModel) tabela_terceiro.getModel();

        var listaTerceiros = TerceiroDAO.listaTerceiro();

        model.setRowCount(0);
        model.getDataVector().removeAllElements();
        model.fireTableDataChanged();
        
        for (int i = 0; i < listaTerceiros.size(); i++) {
            model.addRow(new Object[]{
                listaTerceiros.get(i).getId(),
                listaTerceiros.get(i).getNome(),
                listaTerceiros.get(i).getEmail(),
                listaTerceiros.get(i).getFuncao()
            });
        }
    ...
    /**
     * Creates new form TerceirosView
     */
    public TerceirosView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        field_funcao = new javax.swing.JTextField();
        ...
        tabela_terceiro = new javax.swing.JTable();
        btn_voltar = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setText("Gerenciar Terceiros");
        ...
        jLabel4.setLabelFor(field_funcao);
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel4)
                .addGap(1, 1, 1)
                .addComponent(field_funcao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tabela_terceiro.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tabela_terceiro.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabela_terceiroMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabela_terceiro);
        if (tabela_terceiro.getColumnModel().getColumnCount() > 0) {
            tabela_terceiro.getColumnModel().getColumn(0).setMinWidth(20);
            tabela_terceiro.getColumnModel().getColumn(0).setPreferredWidth(30);
            tabela_terceiro.getColumnModel().getColumn(0).setMaxWidth(50);
        }
    ...
    private void btn_criarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_criarActionPerformed
        if (TerceiroDAO.SalvarTerceiro(field_funcao.getText(), field_nome.getText(), field_email.getText())){
            this.LoadTable();
            JOptionPane.showMessageDialog(this, "Terceiro salvo com sucesso!");
        } else {
            JOptionPane.showMessageDialog(this, "Erro ao salvar o terceiro!");
        }
    ...
    private void btn_atualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_atualizarActionPerformed
        int id = Integer.valueOf(String.valueOf(tabela_terceiro.getValueAt(tabela_terceiro.getSelectedRow(), 0)));
        String nome = String.valueOf(tabela_terceiro.getValueAt(tabela_terceiro.getSelectedRow(), 1));
        String email = String.valueOf(tabela_terceiro.getValueAt(tabela_terceiro.getSelectedRow(), 2));
        String funcao = String.valueOf(tabela_terceiro.getValueAt(tabela_terceiro.getSelectedRow(), 3));
            
        if (TerceiroDAO.ModificarTerceiro(id, funcao, nome, email)){
            this.LoadTable();
            JOptionPane.showMessageDialog(this, "Terceiro atualizado com sucesso!");
        } else {
            JOptionPane.showMessageDialog(this, "Erro ao atualizar terceiro!");
        }
    ...
    private void tabela_terceiroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabela_terceiroMouseClicked
        BotoesUI(false,true,true,false,false);
        int index = tabela_terceiro.getSelectedRow();
        
        field_nome.setText(String.valueOf(tabela_terceiro.getValueAt(index, 1)));
        field_email.setText(String.valueOf(tabela_terceiro.getValueAt(index, 2)));
        field_funcao.setText(String.valueOf(tabela_terceiro.getValueAt(index, 3)));
    }//GEN-LAST:event_tabela_terceiroMouseClicked

    private void btn_removerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_removerActionPerformed
        BotoesUI(true,false,false,false,false);
        int id = Integer.valueOf(String.valueOf(tabela_terceiro.getValueAt(tabela_terceiro.getSelectedRow(), 0)));
        if (TerceiroDAO.ExcluirTerceiro(id)){
            this.LoadTable();
            JOptionPane.showMessageDialog(this, "Terceiro removido com sucesso!");
        } else {
            JOptionPane.showMessageDialog(this, "Erro ao excluir o terceiro!");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TerceirosView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TerceirosView().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField field_funcao;
    ...
    private javax.swing.JTable tabela_terceiro;
