...
import TableModel.TableModelTerceiro;
...
public class TerceirosView extends javax.swing.JFrame {
    TableModelTerceiro Modelo;
    
    public void LoadTable() throws IOException, FileNotFoundException, ClassNotFoundException{
        Modelo = new TableModelTerceiro(TerceiroController.getTerceiros());
        tabela_terceiro.setModel(Modelo);
        
        tabela_terceiro.getColumnModel().getColumn(0).setPreferredWidth(250);
        tabela_terceiro.getColumnModel().getColumn(1).setPreferredWidth(250);
        tabela_terceiro.getColumnModel().getColumn(2).setPreferredWidth(400);
    }
     ...
     */
    public TerceirosView() throws IOException, FileNotFoundException, ClassNotFoundException {
        initComponents();
    ...
    private void btn_criarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_criarActionPerformed
        try {
            if(TerceiroController.SalvarTerceiro(field_funcao.getText(), field_nome.getText(), field_email.getText())){
                this.LoadTable();
            ...
            Logger.getLogger(TerceirosView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btn_atualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_atualizarActionPerformed
        ...
        try {
            if(TerceiroController.ModificarTerceiro(index, field_funcao.getText(), field_nome.getText(), field_email.getText())){
                this.LoadTable();
    ...
    private void tabela_terceiroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabela_terceiroMouseClicked
        ...
        if(index>=0 && index<Modelo.getRowCount()){
            String temp[] = Modelo.getValorTerceiro(index);
            field_funcao.setText(temp[0]);
    ...
    private void btn_removerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_removerActionPerformed
        ...
        int index = tabela_terceiro.getSelectedRow();
        try {
            if(TerceiroController.ExcluirTerceiro(index)){
                this.LoadTable();
