...
public class AlunosView extends javax.swing.JFrame {
    ...
    public void LoadTable() throws IOException, FileNotFoundException, ClassNotFoundException{
        try { 
            ...
            JOptionPane.showMessageDialog(this, "A lista ainda não existe, favor criar um ou mais alunos.");
        }
        
        tabela_aluno.setModel(Modelo);
        
        tabela_aluno.getColumnModel().getColumn(0).setPreferredWidth(200);
     ...
     */
    public AlunosView() throws IOException, FileNotFoundException, ClassNotFoundException {
        initComponents();
        LoadTable();
