...
import Controllers.ProfessorDAO;
...
public class ProfessoresView extends javax.swing.JFrame {
    ...
    public void LoadTable(){
        ...
        var listaProfessores = ProfessorDAO.listaProfessor();
        ...
        for (int i = 0; i < listaProfessores.size(); i++) {
            model.addRow(new Object[]{
                listaProfessores.get(i).getId(),
                listaProfessores.get(i).getNome(),
                listaProfessores.get(i).getEmail(),
                listaProfessores.get(i).getDisciplina()
            });
        }
    ...
    private void initComponents() {
        ...
        if (tabela_professor.getColumnModel().getColumnCount() > 0) {
            tabela_professor.getColumnModel().getColumn(0).setMinWidth(20);
            tabela_professor.getColumnModel().getColumn(0).setPreferredWidth(30);
            tabela_professor.getColumnModel().getColumn(0).setMaxWidth(50);
        }
    ...
    private void btn_criarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_criarActionPerformed
        if(ProfessorDAO.SalvarProfessor(field_disciplina.getText(), field_nome.getText(), field_email.getText())){
            this.LoadTable();
    ...
    private void btn_atualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_atualizarActionPerformed
        int id = Integer.valueOf(String.valueOf(tabela_professor.getValueAt(tabela_professor.getSelectedRow(), 0)));
        String nome = String.valueOf(tabela_professor.getValueAt(tabela_professor.getSelectedRow(), 1));
        String email = String.valueOf(tabela_professor.getValueAt(tabela_professor.getSelectedRow(), 2));
        String disciplina = String.valueOf(tabela_professor.getValueAt(tabela_professor.getSelectedRow(), 3));
        
        if(ProfessorDAO.ModificarProfessor(id, disciplina, nome, email)){
            this.LoadTable();
    ...
    private void tabela_professorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabela_professorMouseClicked
        ...
        field_nome.setText(String.valueOf(tabela_professor.getValueAt(index, 1)));
        field_email.setText(String.valueOf(tabela_professor.getValueAt(index, 2)));
        field_disciplina.setText(String.valueOf(tabela_professor.getValueAt(index, 3)));
